...
const buttonStyle = tva({
  base: 'group/button bg-primary-500 flex-row items-center justify-center gap-2 rounded data-[disabled=true]:opacity-40 data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2',
  variants: {
    action: {
      primary:
        'border-primary-background-hover bg-primary-background data-[active=true]:border-primary-border data-[hover=true]:border-primary-border data-[active=true]:bg-primary-background-hover data-[hover=true]:bg-primary-background-hover data-[focus-visible=true]:web:ring-indicator-info',
      // secondary:
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      primary:
        'text-primary-text data-[active=true]:text-primary-text data-[hover=true]:text-primary-text',
      // secondary:
  ...
  parentCompoundVariants: [
    ...
    },
    {
      ...
      action: 'secondary',
      class:
        'data-[hover=true]:text-primary-600 text-typography-500 data-[active=true]:text-typography-700',
    },
    {
      variant: 'outline',
      action: 'positive',
