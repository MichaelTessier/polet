...
const selectTriggerStyle = tva({
  base: 'data-[focus=true]:border-primary-700 flex-row items-center overflow-hidden rounded border border-background-300 data-[disabled=true]:data-[hover=true]:border-background-300 data-[hover=true]:border-outline-400 data-[disabled=true]:opacity-40',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
    ...
    variant: {
      underlined:
        'data-[hover=true]:border-primary-700 data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 rounded-none border-0 border-b data-[focus=true]:web:shadow-[inset_0_-1px_0_0]',
      outline:
        'data-[focus=true]:border-primary-700 data-[focus=true]:data-[hover=true]:web:shadow-primary-600 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 data-[invalid=true]:data-[hover=true]:border-error-700 data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[invalid=true]:web:shadow-[inset_0_0_0_1px]',
      rounded:
        'data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 rounded-full data-[focus=true]:web:shadow-[inset_0_0_0_1px]',
    },
  },
});
